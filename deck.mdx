...
---
<TallImage style={{padding: 10}} src="assets/slices.png" />
---
# Namespace == Slice
---
# Slytherin.dev
...
# What about typing?
---
Run time vs compile time chart
We need a single entrypoint for types
---
<CodeSurfer
...
<ul>
	<Appear>
  	...
  	<li>we have strong typing to prevent modules from clobbering each oter</li>
	</Appear>
</ul>
---
# Thank You!
